        ...
        tStorages.assertMergeInfo(
            ...
            expected = mapOf(
                mockUUID(1) to mockMergeInfo(
                    ...
                    items = listOf(
                        stringTUpdated.map(StringTransformer::encode),
                ...
                mockUUID(2) to mockMergeInfo(
                    ...
                    items = listOf(
                        intTUpdated.map(IntTransformer::encode),
        ...
        rStorages.assertMergeInfo(
            ...
            expected = mapOf(
                mockUUID(1) to mockMergeInfo(
                    ...
                    items = listOf(
                        stringRUpdated.map(StringTransformer::encode),
                ...
                mockUUID(2) to mockMergeInfo(
                    ...
                    items = listOf(
                        intRUpdated.map(IntTransformer::encode),
